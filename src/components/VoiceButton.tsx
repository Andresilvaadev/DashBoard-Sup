  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-[calc(5.25rem+var(--barra-acoes-celular,0px)+env(safe-area-inset-bottom))] right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-xl transition-colors md:bottom-6 md:right-6 ${
          fase === 'gravando'
      ...
      {fase === 'gravando' && (
        <div className="fixed bottom-[calc(9.25rem+var(--barra-acoes-celular,0px)+env(safe-area-inset-bottom))] right-4 z-50 rounded-lg bg-slate-800 px-4 py-2 text-sm shadow-lg md:bottom-24 md:right-6">
      ...
      {comando && fase === 'ocioso' && (!comando.numero || !comando.etapa) && (
        <div className="fixed bottom-[calc(9.25rem+var(--barra-acoes-celular,0px)+env(safe-area-inset-bottom))] right-4 z-50 max-w-xs rounded-lg bg-amber-700 px-4 py-2 text-sm shadow-lg md:bottom-24 md:right-6">
